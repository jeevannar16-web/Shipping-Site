      ...
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] lg:items-start">
        <div className="lg:sticky lg:top-32" data-reveal>
          ...
          <h2 className="font-display text-4xl font-bold leading-tight tracking-tight md:text-6xl">
            ...
            <span className="text-glow-orange text-neon-orange"> move with confidence.</span>
          </h2>
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3 text-sm font-semibold text-white transition-all hover:border-cyber-blue hover:text-cyber-blue"
          >
            ...
            return (
              <div
                ...
                className={`overflow-hidden rounded-2xl border transition-colors duration-300 ${
                  isOpen ? 'border-neon-orange/40 bg-graphite' : 'border-white/10 bg-carbon'
                }`}
              >
                <button
                ...
                >
                  <span className={`font-display text-base font-semibold transition-colors duration-300 md:text-lg ${isOpen ? 'text-neon-orange' : 'text-white'}`}>
                    {faq.q}
                  </span>
                  <span
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border transition-all duration-300 ${
                      isOpen ? 'rotate-180 border-neon-orange text-neon-orange' : 'border-white/15 text-white/60'
                    }`}
                  >
