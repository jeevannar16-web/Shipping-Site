        ...
        <nav className="flex flex-1 flex-col justify-center gap-1 px-6 md:px-16">
          {NAV_LINKS.map((link, i) => (
            ...
            >
              ...
              <span
                className="font-display text-4xl font-bold tracking-tight text-white/90 transition-all duration-500 group-hover:translate-x-2 group-hover:text-cyber-blue md:text-7xl"
