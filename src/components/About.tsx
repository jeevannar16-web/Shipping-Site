...
function StatItem({
  ...
  return (
    <div className="group relative flex-1 py-8 text-center">
      <p className="font-display text-4xl font-bold tracking-tight text-white transition-colors duration-300 group-hover:text-teal md:text-6xl">
        <span ref={ref}>0</span>
  ...
  return (
    <section id="about" className="relative mx-auto max-w-7xl px-6 py-28 md:py-36">
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-start">
        <div>
          <p className="mb-4 flex items-center gap-3 text-xs uppercase tracking-[0.3em] text-gold" data-reveal>
            <span className="h-px w-10 bg-gold" />
            About Jeevan Global Logistics
          </p>
          <h2 className="font-display text-4xl font-bold leading-tight tracking-tight md:text-6xl" data-reveal>
            We move freight.
            <br />
            <span className="text-glow-gold text-gold">We own the outcome.</span>
          </h2>
          ...
          <a
            href="#services"
            className="group mt-10 inline-flex items-center gap-2 text-sm font-semibold text-teal transition-colors hover:text-white"
            data-reveal
          >
